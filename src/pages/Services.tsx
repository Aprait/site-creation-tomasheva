  ...
  const services = [
    {
      ...
      formats: [
        { name: "Месячный пакет", duration: "4 встречи по 90 минут", price: "от 120 000 ₽" },
        { name: "Квартальный пакет", duration: "12 встреч + поддержка в чате", price: "от 300 000 ₽" },
        { name: "Годовое сопровождение", duration: "48 встреч + стратегические сессии", price: "от 1 000 000 ₽" }
      ],
      icon: "Target",
    ...
    },
    {
      ...
      formats: [
        { name: "Однодневная сессия", duration: "8 часов + подготовка", price: "от 200 000 ₽" },
        { name: "Двухдневная сессия", duration: "2 дня + 2 недели подготовки", price: "от 350 000 ₽" },
        { name: "С сопровождением", duration: "Сессия + 3 месяца поддержки", price: "от 600 000 ₽" }
      ],
      icon: "Users",
    ...
    },
    {
      ...
      formats: [
        { name: "Проектирование системы", duration: "1 месяц + документация", price: "от 400 000 ₽" },
        { name: "Внедрение с обучением", duration: "3 месяца + поддержка команды", price: "от 900 000 ₽" },
